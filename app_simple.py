...
async def sessions_page(request: Request):
    ...
    try:
            ...
            for session in sessions:
                ...
                <div class="session-card">
                    ...
                    <div class="session-actions">
                        ...
                        <a href="/real-sessions" class="btn-augment">🔄 Augmentar</a>
        ...
        <head>
            <meta charset="UTF-8">
            <title>Gestión de Sesiones - YOLO Annotator</title>
            <style>
                body {{
                    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
                    margin: 0;
                ...
                .btn-visualize {{ background: rgba(23, 162, 184, 0.8); color: white; }}
                .btn-augment {{ background: rgba(255, 193, 7, 0.8); color: #333; }}
                .btn-delete {{ background: rgba(220, 53, 69, 0.8); color: white; }}
                .btn-create {{ 
                    background: #28a745; 
                    color: white; 
                    padding: 15px 30px; 
